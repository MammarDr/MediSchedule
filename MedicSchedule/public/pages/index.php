        ...
        <div class="container">
            <div class="primary">
                ...
                <div class="reserve-btn flex">
                    <button <?php if(isset($_SESSION['user_id'])) { echo 'onclick="window.location.href=\'booking.php\'"'; } ?>>Book Your Appointment</button>
                    <button class="manage" <?php if(isset($_SESSION['user_id'])) { echo 'onclick="window.location.href=\'appointment.php\'"'; } ?>>Manage Your Appointment</button>
                </div>
